...
public class VNPAYConfig {
    ...
    public static final String VNP_RETURN_URL = "http://localhost:8080/api/v1/callback";
    public static final String VNP_TMN_CODE = "6P4HZ4D4";
    public static final String SECRET_KEY = "HECUONEHZKNXYLSVMCEALUHGSRLLJZPV";
